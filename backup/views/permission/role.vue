...
import { deepClone,filterThree} from '@/utils'
import { getRoutes, getRoles, addRole, deleteRole, updateRole } from '@/api/role'
import i18n from '@/lang'
import {asyncRou} from '@/router/index2';
...
export default {
  ...
  methods: {
    ...
    async confirmRole() {
      ...
      this.role.routes = filterThree(this.serviceRoutes,checkedNode);
